...
def matrix_divided(matrix, div):
    ...
    Raises:
        TypeError: If `matrix` is not a list of lists of integers/floats,
                   or if `div` is not a number, or if rows of `matrix` are not of the same size.
        ZeroDivisionError: If `div` is zero.

    Returns:
        list of lists of float: The new matrix with divided values rounded to 2 decimal places.
    """
