...
class Rectangle:
    ...
    def __str__(self):
        """Returns a string representation of the rectangle using the character(s) in print_symbol."""
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __repr__(self):
        """Returns a string representation that can recreate the instance using eval()."""
