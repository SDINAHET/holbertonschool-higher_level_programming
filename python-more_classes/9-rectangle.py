...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        and increments the instance count.
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: The rectangle with the bigger area, or rect_1 if both
            have the same area.
    ...
    def square(cls, size=0):
        """
        Class method that returns a new Rectangle instance where width and
        height are equal to size.
